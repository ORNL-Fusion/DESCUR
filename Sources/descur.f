...
!
!        READ INPUT DATA FILE ON COMMAND LINE, RATHER THAN INTERACTIVE MODE
         CALL read_indata(command_arg(1), iunit, ier_flag,
     1                    nphi20, rbdy_3d, zbdy_3d)
         IF (ier_flag .ne. 0) STOP 'ERROR READING INPUT FILE'
         GO TO 1006
      ENDIF
